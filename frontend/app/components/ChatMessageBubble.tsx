      ...
      <VStack align="start" spacing={5} pb={5}>
        {!isUser && filteredSources.length > 0 && (
            <>
              <Flex direction={"column"} width={"100%"}>
                <VStack spacing={"5px"} align={"start"} width={"100%"}>
                  <Heading
                      ...
                      fontWeight={"medium"}
                      mb={1}
                      color={"#1E40AF"} /* Updated to match the light theme */
                      paddingBottom={"10px"}
                  >
                    Sources
                  </Heading>
              ...
              <Heading size="lg" fontWeight="medium" color="#1E40AF">
                Answer
              </Heading>
            </>
        )}
        ...
        {isUser ? (
            <Heading size="lg" fontWeight="medium" color="#262629">
              {content}
            </Heading>
        ) : (
            <Box className="whitespace-pre-wrap" color="#262629">
              {answerElements}
            </Box>
        )}
